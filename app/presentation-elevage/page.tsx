...
const pageImage = "/pages/homePage/spitz-nain-pomeranien-blanc-beige-gris.webp"
...
const educationalWorkSectionParagraphs = [
    ...
    "Votre chiot par donc avec la connaissance du rappel en lieu clos, vaste ou avec peu de distraction en extérieur : il est rapide à acquérir avec un SPITZ NAIN POMÉRANIEN s’il est pratiqué de façon journalière. Ensuite, nous allons vous guider, mais il faudra toujours travailler progressivement et de façon régulière, avec l’aide d’une grande longe. Avec de la patience, du temps, de la vigilance, de la motivation, et de l’amour, absolument tout est réalisable !",
    "La propreté : votre chiot SPITZ NAIN POMÉRANIEN partira avec l’habitude de faire ses besoins dans un lieu pré défini, et sur tous types de substrats naturels : cela l’aidera durant la phase d’adaptation chez vous et facilitera l’apprentissage de la propreté en appartement.",
...
const presentationInternalLinks: InternalLinkItem[] = [
    {
        ...
        description: "Découvrir le parcours d’Aurélie et Marine et leur vision du Spitz nain Poméranien.",
    },
    {
        ...
        images: [
            {
                ...
                alt: "Chiot spitz-pomeranien blanc dans un decor doux",
                width: 1200,
                height: 630,
                type: "image/jpeg",
            },
            ...
            <div className="py-16">
                <div className="container mx-auto">
                    <section className="text-center space-y-6 mb-16">
                        <h1 className="text-xl md:text-3xl font-bold">L&apos;élevage Spitz nain Poméranien - Spitz nain Poméranien</h1>
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                            Élevage spécialisé Spitz nain Poméranien en Saône-et-Loire (71) à la frontière du Jura.
                        </p>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Nous sommes passionnées par les chiens primitifs et la culture canine, et nous avons choisi de nous investir dans le développement du Spitz nain Poméranien, un Spitz nain Poméranien de taille miniature. Notre élevage est situé dans un cadre calme et propice à l’observation, au respect du rythme de chaque chien et à la construction d’un lien solide avec les familles.
                        </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                ...
                                <h2 className="text-xl md:text-2xl font-bold">
                                    Faire naître des Spitz nain Poméranien bien dans leur tête
                                </h2>
                                <p className="text-muted-foreground leading-relaxed">
                                    ...
                                    développement de cette nouvelle race en création qu’est le SPITZ NAIN POMÉRANIEN, un SPITZ NAIN POMÉRANIEN,
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    ...
                                    Chaque chiot Spitz nain Poméranien bénéficie d’un départ progressif, calme et structuré.
                                </p>
                                <p className="text-muted-foreground leading-relaxed">
                                    ...
                                    L’objectif est de former un Spitz nain Poméranien confiant, propre, bien codé et prêt à créer
                            ...
                            <div className="relative h-82 md:h-100 rounded-lg overflow-hidden">
                                <Image
                                    ...
                                    alt="Espaces extérieurs sécurisés de l'élevage pour les Spitz nain Poméranien"
                                    fill
                            ...
                            <Card className="text-center bg-muted/80">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        ...
                                        du Spitz nain Poméranien sans le surstimuler.
                                    </p>
                                </CardContent>
                            </Card>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="relative h-82 md:h-100 rounded-lg overflow-hidden md:order-2">
                                <Image
                                    ...
                                    alt="Spitz nain Poméranien attentif au milieu des branches"
                                    fill
                                    className="object-cover"
                                    sizes="(min-width: 768px) 50vw, 100vw"
                                    quality={75}
                            ...
                            <div className="space-y-6 md:order-1">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Le Spitz nain Poméranien n’est pas un petit chien banal : il est observateur, intelligent,
                    ...
                    <section className="mb-16 space-y-6">
                        <div className="text-center space-y-3">
                            <h2 className="text-xl md:text-2xl font-bold">L’EDUCATION DU SPITZ NAIN POMÉRANIEN :</h2>
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        src="/pages/image-all-spitz/humain-avec-spitz-pomeranien-exterieur-02.jpeg"
                                        alt="Interaction en extérieur entre l'éleveuse et un Spitz nain Poméranien"
                                        fill
                                        className="object-cover"
                            ...
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        src="/pages/image-all-spitz/spitz-pomeranien-jardin-01.webp"
                                        alt="Spitz nain Poméranien évoluant librement dans les espaces extérieurs de l'élevage"
                                        fill
                                        className="object-cover"
                                        sizes="(min-width: 768px) 33vw, 100vw"
                                        quality={75}
                            ...
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        src="/pages/image-all-spitz/spitz-pomeranien-en-laisse-parc-01.webp"
                                        alt="Spitz nain Poméranien accompagné en laisse lors d'une sortie en extérieur"
                                        fill
                                        className="object-cover"
                                        sizes="(min-width: 768px) 33vw, 100vw"
                                        quality={75}
                    ...
                    <section id="travail-educatif-elevage" className="mb-16 space-y-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        ...
                                        alt="Spitz nain Poméranien en longe dans l'herbe"
                                        fill
                                        className="object-cover"
                                        sizes="(min-width: 768px) 33vw, 100vw"
                                        quality={75}
                            ...
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        src="/pages/image-all-spitz/spitz-pomeranien-jardin-ensemble-02.webp"
                                        alt="Spitz nain Poméranien évoluant en extérieur dans l'environnement de l'élevage"
                                        fill
                                        className="object-cover"
                                        sizes="(min-width: 768px) 33vw, 100vw"
                                        quality={75}
                            ...
                            <figure className="space-y-3">
                                <div className="relative h-82 rounded-lg overflow-hidden">
                                    <Image
                                        src="/pages/image-all-spitz/spitz-pomeranien-en-laisse-avec-humain-01.webp"
                                        alt="Spitz nain Poméranien en laisse avec un humain pendant un apprentissage en extérieur"
                                        fill
                                        className="object-cover"
                                        sizes="(min-width: 768px) 33vw, 100vw"
                                        quality={75}
                    ...
                    <section className="mb-16 bg-muted/30 -mx-4 px-4 py-16 rounded-lg">
                        <div className="max-w-4xl mx-auto text-center space-y-6">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                Notre histoire s’est naturellement orientée vers le Spitz nain Poméranien à travers notre passion pour
                                les chiens primitifs et la culture canine. Installées dans le Jura, nous avons voulu
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                Notre objectif n’est pas de produire vite, mais de faire naître des Spitz nain Poméranien harmonieux,
                            ...
                            <Card className="bg-muted/80">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-muted-foreground text-sm leading-relaxed">
                                        ...
                                        Spitz nain Poméranien sereins et curieux.
                                    </p>
                                </CardContent>
                            </Card>
                    ...
                    <FAQSection
                        title="FAQ élevage et Spitz nain Poméranien"
                        description="Nos réponses sur l’élevage, le caractère du Spitz nain Poméranien et la manière dont nous préparons nos chiots."
                        items={faqPresentation}
                    />

                    <section className="text-center space-y-6">
                        <h2 className="text-xl md:text-2xl font-bold">
                            Envie de découvrir notre univers Spitz nain Poméranien ?
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
